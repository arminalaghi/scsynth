 ...
 */
module LFSR_70_bit_added_zero_asd(//Linear feedback shift register
	input [69:0] seed, //Initial value
	output [69:0] data, //Current value
	...
	always @(posedge clk or posedge reset) begin
		...
		else if (enable) shift_reg <= {shift_reg[68:0], shift_in};
	end
	...
	wire zero_detector;
	assign zero_detector = ~(|(shift_reg[68:0]));
