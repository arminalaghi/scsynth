 ...
 */
module LFSR_12_bit_added_zero_example(//Linear feedback shift register
	input [11:0] seed, //Initial value
	output [11:0] data, //Current value
	...
	always @(posedge clk or posedge reset) begin
		...
		else if (enable) shift_reg <= {shift_reg[10:0], shift_in};
	end


	wire xor_out;
	assign xor_out = shift_reg[11] ^ shift_reg[10] ^ shift_reg[9] ^ shift_reg[3];

	wire zero_detector;
	assign zero_detector = ~(|(shift_reg[10:0]));
